...
public final class Building {
    ...
    private Building(List<Floor> floors, List<ElevatorCar> elevators, ElevatorController controller) {
    ...
    public static Building create(int floorCount, int elevatorCount, int maxLoadKg, SchedulingStrategy strategy) {
        if (floorCount < 1 || elevatorCount < 1 || maxLoadKg < 1)
            throw new IllegalArgumentException("Floor count, elevator count, and capacity must be positive");
    ...
    public List<ElevatorCar> elevators() {
        return elevators;
    }
